...
using DataExtractor.EmailTemplateCreator;
using DataExtractor.ETService;
using IExactTargetConfiguration = DataExtractor.Core.Configuration.IExactTargetConfiguration;
using System.Linq;
